...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(e,t,n){let r=new Float32Array(go),i=new q(0,1,0);return new Oi({name:`SphericalGaussianBlur`,defines:{n:go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:No(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(){return new Oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:No(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new Oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:No(),fragmentShader:`
	...
	`}var Po=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,blending:2,side:1,transparent:!0})),Vl.add(tu);let e=8e4,t=18.5,n=new Float32Array(e*3),r=new Float32Array(e*3),i=new X(`#fbe3ff`),a=new X(`#d1a3ff`),o=new X(`#8a6bb5`);for(let s=0;s<e;s++){let e=11+Math.random()*(t-11),c=Math.random()*Math.PI*2,l=Math.sin(c)*e,u=Math.cos(c)*e,d=(Math.random()-.5)*.4;n[s*3]=l,n[s*3+1]=d,n[s*3+2]=u;let f=(e-11)/(t-11),p=new X;f<.4?p.lerpColors(i,a,f/.4):p.lerpColors(a,o,(f-.4)/.6),r[s*3]=p.r,r[s*3+1]=p.g,r[s*3+2]=p.b}let s=new wr;s.setAttribute(`position`,new lr(n,3)),s.setAttribute(`color`,new lr(r,3)),nu=new ui(s,new ai({size:.16,vertexColors:!0,transparent:!0,opacity:.95,map:iu(),blending:2,depthWrite:!1})),Vl.add(nu)}function ou(){eu&&(eu.rotation.y+=.001,tu.position.copy(eu.position),nu.position.copy(eu.position),nu.rotation.y+=6e-4)}var su;function cu(){let e=25e3,t=new Float32Array(e*3),n=new Float32Array(e*3),r=new X(`#ff66ff`),i=new X(`#ffffff`);for(let a=0;a<e;a++){let e=a*3,o=Math.random()*180,s=o*.28,c=a%6*(Math.PI*2/6),l=(Math.random()-.5)*8,u=(Math.random()-.5)*3,d=(Math.random()-.5)*8;t[e]=Math.cos(c+s)*o+l,t[e+1]=u,t[e+2]=Math.sin(c+s)*o+d;let f=r.clone();f.lerp(i,o/180),n[e]=f.r,n[e+1]=f.g,n[e+2]=f.b}let a=new wr;a.setAttribute(`position`,new lr(t,3)),a.setAttribute(`color`,new lr(n,3)),su=new ui(a,new ai({size:.35,transparent:!0,opacity:.9,depthWrite:!1,vertexColors:!0,blending:2})),Vl.add(su)}function lu(){su&&(su.rotation.y+=5e-4)}var uu=[`images/planet1.jpg`,`images/planet2.jpg`,`images/planet3.jpg`,`images/planet4.jpg`,`images/planet5.jpg`,`images/planet6.jpg`,`images/planet7.jpg`,`images/planet8.jpg`,`images/planet9.jpg`,`images/planet10.jpg`,`images/planet11.jpg`,`images/planet12.jpg`,`images/planet13.jpg`],du=new Xi,fu=`./`;function pu(e){let t=String(e).replace(/^\/+/,``);return/^(https?:)?\/\//i.test(t)||t.startsWith(`data:`)?t:new URL(`${fu}${t}`,document.baseURI).href}function mu(e){let t=document.getElementById(`load-text`);t&&(t.textContent=e)}du.onStart=function(e){console.log(`Start loading:`,e)},du.onProgress=function(e,t,n){mu(`Dang nap du lieu khong gian... ${Math.round(t/n*100)}%`)},du.onLoad=function(){console.log(`All assets are ready.`),mu(`He thong vu tru da nap hoan tat!`);let e=document.getElementById(`enter-btn`);e&&(e.disabled=!1,e.style.display=`inline-flex`)},du.onError=function(e){console.error(`Cannot load asset:`,e),mu(`Co tep anh hoac nhac khong tai duoc. Hay kiem tra ten file tren GitHub.`)};var hu=new ia(du),gu=new Ea(du),_u=new Sn;Vl.add(_u);var vu=[],yu=new Tt;function bu(e){let t=document.createElement(`canvas`);t.width=512,t.height=680;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,t.width,t.height);r.addColorStop(0,`#24143a`),r.addColorStop(1,`#040713`),n.fillStyle=r,n.fillRect(0,0,t.width,t.height),n.strokeStyle=`rgba(255, 187, 251, 0.8)`,n.lineWidth=8,n.strokeRect(28,28,t.width-56,t.height-56),n.fillStyle=`#ffffff`,n.font=`32px sans-serif`,n.textAlign=`center`,n.fillText(`Image not found`,t.width/2,t.height/2-20),n.fillStyle=`rgba(255, 255, 255, 0.7)`,n.font=`22px sans-serif`,n.fillText(e,t.width/2,t.height/2+26);let i=new pi(t);return i.colorSpace=Le,i}function xu(){uu.forEach((e,t)=>{let n=pu(e),r=hu.load(n,void 0,void 0,()=>{console.error(`Photo failed to load:`,n),a.material.map=bu(e),a.material.needsUpdate=!0});r.colorSpace=Le,r.minFilter=c,r.generateMipmaps=!1;let i=new qr(new _i(4.8,6.2,.12),new ji({color:16777215,roughness:.3,metalness:0,clearcoat:1}));i.position.z=-.06;let a=new qr(new vi(4.4,5.8),new Fr({map:r,transparent:!0,side:2}));a.position.z=.01;let o=new Sn;o.add(i),o.add(a);let s=t/uu.length*Math.PI*2,l=wt.randFloat(-2,5);o.position.set(Math.cos(s)*20,l,Math.sin(s)*20),o.userData={angle:s,radius:20,baseY:l,speed:wt.randFloat(3e-4,8e-4),floatOffset:Math.random()*Math.PI*2,floatSpeed:wt.randFloat(.004,.008)},_u.add(o),vu.push(o)})}function Su(e){if(_u.rotation.y+=5e-5,!e)return;let t=Date.now();vu.forEach(n=>{let r=n.userData;r.angle+=r.speed,n.position.x=Math.cos(r.angle)*r.radius,n.position.z=Math.sin(r.angle)*r.radius,n.position.y=r.baseY+Math.sin(t*r.floatSpeed+r.floatOffset)*.25,yu.copy(e.quaternion),n.quaternion.copy(yu),n.rotation.y-=_u.rotation.y,n.rotation.z+=Math.sin(t*.002+r.floatOffset)*.04})}var Cu,wu,Tu=!1,Eu=!1;function Du(e){let t=document.querySelector(`.cosmic-hud p`);t&&(t.textContent=e)}async function Ou(){if(Eu=!0,!wu||!Tu){Du(`Dang chuan bi nhac nen...`);return}let e=Cu?.context;e?.state===`suspended`&&await e.resume(),wu.isPlaying||(wu.play(),Du(`Nhac nen dang phat...`))}function ku(){Ou().catch(e=>{console.error(`Cannot start background music:`,e),Du(`Trinh duyet dang chan nhac nen. Hay cham man hinh them mot lan.`)})}function Au(){Cu=new Ra,Hl.add(Cu),wu=new za(Cu),gu.load(pu(`space-bgm.mp3`),e=>{wu.setBuffer(e),wu.setLoop(!0),wu.setVolume(.4),Tu=!0,console.log(`Background music loaded.`),Eu&&ku()},void 0,e=>{console.error(`Cannot load background music:`,e),Du(`Khong tai duoc nhac nen. Hay kiem tra file space-bgm.mp3.`)}),window.addEventListener(`galaxy:start`,ku),window.addEventListener(`pointerdown`,ku,{once:!0}),window.addEventListener(`touchend`,ku,{once:!0}),window.addEventListener(`keydown`,ku,{once:!0})}var ju=`
    varying vec2 vUv;
    void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,Nu,Pu={uTime:{value:0}};function Fu(e){Nu=new qr(new yi(500,32,32),new Oi({vertexShader:ju,fragmentShader:Mu,uniforms:Pu,side:1})),e.add(Nu)}function Iu(e){Pu&&(Pu.uTime.value=e*.001)}function Lu(){let e=document.createElement(`style`);e.textContent=`
    #loading-screen {
      position: fixed;
      inset: 0;
      z-index: 9999;
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.id=`loading-screen`,t.innerHTML=`
  ...
  `,document.body.appendChild(t);let n=document.createElement(`div`);n.className=`cosmic-hud`,n.innerHTML=`
    <h1>by_nguyenvanan</h1>
    <p>He thong khong gian ao on dinh</p>
  `,document.body.appendChild(n),document.getElementById(`enter-btn`).addEventListener(`click`,()=>{window.dispatchEvent(new Event(`galaxy:start`)),t.style.opacity=`0`,window.setTimeout(()=>{t.remove()},750)})}Lu(),au(),cu(),xu(),Au(),Fu(Vl);function Ru(e){requestAnimationFrame(Ru),Wl?.update(),Vl?.updateMatrixWorld(!0),ou(),lu(),Iu(e),Su(Hl),Ul&&Vl&&Hl&&Ul.render(Vl,Hl)}requestAnimationFrame(Ru);